...
if __name__=="__main__":
	...
	bench('tcc',test_c,  'ackermann_jnz',  [3,5],    repeat=3, mem_size=100_000)
	bench('py', test_py, 'ackermann_jz',   [3,5],    repeat=3, mem_size=100_000)
	bench('tcc',test_c,  'ackermann_jz',   [3,5],    repeat=3, mem_size=100_000)
	...
	bench('tcc',test_c,  'random_inc',     [30_000], repeat=10)
	bench('tcc',test_c,  'loops6',         [6],      repeat=10)
	bench('tcc',test_c,  'loops6_inc',     [6],      repeat=10)
	bench('tcc',test_c,  'loops6_inc_inc', [6],      repeat=10)
